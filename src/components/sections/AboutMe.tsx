    ...
    return (
        <section id="about-me" className="relative min-h-screen overflow-clip flex flex-col items-center pb-8 justify-center text-white">
            ...
            <div style={{ fontSize: 'clamp(1.2rem, 1.5vw, 1.5rem)' }}
                ...
                <p>
                    Hey! I&apos;m Miha, a 23-year-old computer science student and software developer from Slovenia. I love transforming wild ideas into real projects, whether it&apos;s game design, machine learning, or automation—essentially anything that combines fun with tech.
                </p>
                <p>
